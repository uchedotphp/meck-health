<template>
  <header class="d-flex justify-content-between align-items-center">
    <span>
      <img
        class="w-auto"
        src="../assets/imgs/meck-logo.png"
        alt="meck health logo"
      />
    </span>
    <span role="button" type="button" class="p-0 position-relative">
      <svg
      ...
      <span
        v-if="isToastOpen"
        style="padding: 3px; top: 6px; right: 1px"
